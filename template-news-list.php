    ...
    <section class="list-con container">
      ...
      <ul class="nav nav-tabs nav-stacked col-xs-3" role="tablist">
        <li role="presentation" class="active">
          <a href="#about_company" aria-controls="home" role="tab" data-toggle="tab">新闻中心</a>
        </li>
        <li role="presentation">
          <a href="#about_porpose" aria-controls="profile" role="tab" data-toggle="tab">公示公告</a>
        </li>
      </ul>
